  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#030303] text-[#f3f4f6] px-6 py-12 relative overflow-hidden select-none">
      ...
      <div className="z-10 flex flex-col items-center text-center max-w-md w-full space-y-8">
        ...
        >
          <Link to="/" className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[var(--accent)] text-accent-foreground text-xs font-black uppercase tracking-widest shadow-lg shadow-[var(--accent)]/20 hover:shadow-[var(--accent)]/30 hover:scale-[1.02] active:scale-[0.98] transition-all border-none no-underline">
