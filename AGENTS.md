...
# Calyxo Routing & Integration Rules
...
- NEVER modify, edit, or disrupt Gemini API service files (`src/services/geminiService.js` and `api/gemini.js`) when working on unrelated feature changes.
